...
# Kernel base version
KERNEL_BASE_VERSION = 4.19-306

# The kernel cmdline to use
KERNEL_BOOTIMAGE_CMDLINE = console=tty0 earlycon=msm_geni_serial,0x4a90000 androidboot.hardware=qcom androidboot.console=tty0 androidboot.memcg=1 lpm_levels.sleep_disabled=1 video=vfb:640x400,bpp=32,memsize=3072000 msm_rtb.filter=0x237 service_locator.enable=1 swiotlb=2048 loop.max_part=7 androidboot.selinux=permissive buildvariant=userdebug datapart=/dev/mmcblk0p1
...
DEVICE_FULL_NAME = Xiaomi Redmi 10C
...
# Defconfig to use
KERNEL_DEFCONFIG = vendor/fog-halium_defconfig
...
KERNEL_BOOTIMAGE_SECONDIMAGE_OFFSET = 0xfef3aa9b
...
DEB_TOOLCHAIN = clang-android-12.0-r416183b, linux-initramfs-halium-generic:arm64, binutils-aarch64-linux-gnu, clang-android-6.0-4691093, gcc-4.9-aarch64-linux-android, g++-4.9-aarch64-linux-android, libgcc-4.9-dev-aarch64-linux-android-cross
